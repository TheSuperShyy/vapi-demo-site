...
function prompt(data, lang) {
  ...
  return `You are a political campaign analyst reading the results of an automated pre-election phone survey in Israel. A voice agent named Michal asks people whether they intend to vote, and asks those who say no or unsure for the reason.
...
- Say "people", not "contacts", "leads", "records" or "users". Michal is the person calling.
...
- The page has already worked out these actions from the numbers, and shows any that apply:
  call many more people; check the phone system; change Michal's opening line; look at the calls
  that broke; try the numbers that did not pick up again; say up front that Michal is a computer;
