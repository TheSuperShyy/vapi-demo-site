...
export const I18N = {
  en: {
    ...
    'page.analysis': 'Analysis', 'page.analysis.sub': 'What happened on the calls, in plain words',
    'page.agent': 'Voice Agent', 'page.agent.sub': 'Talk to him from the browser. No phone call.',
  ...
  he: {
    ...
    'page.analysis': 'ניתוח', 'page.analysis.sub': 'מה קרה בשיחות, במילים פשוטות',
    'page.agent': 'סוכן קולי', 'page.agent.sub': 'דברו איתו מהדפדפן. בלי שיחת טלפון.',
