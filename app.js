...
export const I18N = {
  en: {
    ...
    'page.analysis': 'Analysis', 'page.analysis.sub': 'Three questions in order: did we reach people, what did they say, and what should change',
  ...
  he: {
    ...
    'page.analysis': 'ניתוח', 'page.analysis.sub': 'שלוש שאלות לפי הסדר: הגענו לאנשים, מה הם אמרו, ומה צריך לשנות',
